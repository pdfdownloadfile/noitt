...
if (create) {
      ...
      // Your code for creating a table goes here
            ...
            CREATE TABLE IF NOT EXISTS moitt (
    ...
    const tableName = 'moitt'; // Replace with the name of the table to delete
    ...
    db.query(deleteQuery, (err, result) => {
      ...
      const query = 'SELECT * FROM moitt ORDER BY notify'; // Replace with your table name
